...
{
    public class TaskCommentRepository : Base.Repository, ITaskCommentRepository, IFilterRepository<TaskCommentResult, Domains.User.Task.TaskComment, TaskCommentFilter>
    {
